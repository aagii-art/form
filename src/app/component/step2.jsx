        ...
        <div className="flex flex-col h-full" >
           ...
           { inputData.map((v,i) => {
                    ...
                    <div key={i} >
                        ...
                        <input type={v.type}
                         ...
                         className={` text-[#121316] outline-none  placeholder-[#CBD5E1]  p-3  mt-2 w-full leading-5 rounded-md 
                             ${ error[v.label] ? "  border-3 border-red-500 focus:border focus:border-[#0CA5E9] "
                           :  "border-3 border-[#CBD5E1] focus:border-[#0CA5E9] focus:border " } `}/>
            ...
            <div className=" mt-auto flex gap-2  h-[44px]    " >
               <button onClick={b} className=" border border-[#CBD5E1] w-[30%] hover:bg-gray-100 h-full rounded-md  " > &lt; Back</button>
               <button onClick={nextButton} className="bg-[#121316] text-white w-[70%] hover:opacity-80 rounded-md h-full " > Continue 2/3 &gt; </button>
